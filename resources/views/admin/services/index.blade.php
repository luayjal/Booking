<x-dashboard-layout header="{{ __('services') }}">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <a href="{{ route('admin.services.create') }}" class="btn btn-success">اضافة <i class="fas fa-plus"
                                        ...
                                        <td>
                                            <a href="{{ route('admin.services.edit', $service->id) }}"
                                                class="btn btn-sm btn-outline-primary"><i
                                                    ...
                                                    <button service_id="{{$service->id}}" type="button" class="btn btn-sm btn-outline-danger btn_delete"><i
    ...
    <script>
        $(".btn_delete").on('click',function(){
            ...
            form.attr('action','/dashboard/services/'+id);
            $('#deleteModal').modal()
        });
    </script>
        <script>
